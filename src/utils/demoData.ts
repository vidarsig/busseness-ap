  ...
  const jobs: Job[] = [
    {
      ...
      name:        isIS ? 'Þakviðgerð — Skólavörðustígur'      : isEN_US ? 'Roof Repair — Main St, Brooklyn'     : 'Roof Repair — Oak Street',
      clientName:  isIS ? 'Jón Gunnarsson'                      : 'James Harrington',
      clientEmail: isIS ? 'jon@example.is'                      : isEN_US ? 'james@example.com'                  : 'james@example.co.uk',
      clientPhone: isIS ? '555-1234'                            : isEN_US ? '(718) 555-0123'                     : '07700 900123',
      address:     isIS ? 'Skólavörðustígur 12, 101 Reykjavík' : isEN_US ? '123 Main Street, Brooklyn, NY 11201' : '14 Oak Street, London EC1A 1BB',
    ...
    },
    {
      ...
      name:        isIS ? 'Eldhúsuppsetning — Hafnarfjörður'    : isEN_US ? 'Kitchen Remodel — Park Slope, BK'    : 'Kitchen Installation — Riverside',
      clientName:  isIS ? 'Sigríður Björnsdóttir'               : 'Patricia Williams',
      clientEmail: isIS ? 'sigridur@example.is'                 : isEN_US ? 'pat@example.com'                    : 'pat@example.co.uk',
      clientPhone: isIS ? '555-5678'                            : isEN_US ? '(917) 555-0456'                     : '07700 900456',
      address:     isIS ? 'Suðurgata 7, 220 Hafnarfjörður'      : isEN_US ? '456 Oak Avenue, Queens, NY 11354'   : '45 High Street, Manchester M1 1AD',
    ...
    },
    {
      ...
      name:        isIS ? 'Steypuvinna — Kópavogur'             : isEN_US ? 'Concrete Foundation — Staten Island'  : 'Concrete Foundation — Northside',
      clientName:  isIS ? 'Byggingafélag Suðurnesja ehf'        : isEN_US ? 'Riverside Developments LLC'           : 'Northside Developments Ltd',
  ...
  return {
    ...
    settings: {
      ...
      company: {
        ...
        name:        isIS ? 'Sigurður Builders ehf'    : isEN_US ? 'Sigurdur Builders LLC'       : 'Sigurdur Builders Ltd',
        kennitala:   isIS ? '550892-2349'              : isEN_US ? '82-1234567'                  : '',
        address:     isIS ? 'Klapparstígur 25'         : isEN_US ? '30 N Gould St, Sheridan'     : '25 Harbour Road',
        postalCode:  isIS ? '101'                      : isEN_US ? 'WY 82801'                    : 'EC1A 1BB',
        city:        isIS ? 'Reykjavík'                : isEN_US ? 'New York'                    : 'London',
        email:       isIS ? 'sigurdur@builders.is'     : isEN_US ? 'info@sigurdurbuilders.com'   : 'info@sigurdurbuilders.co.uk',
        phone:       isIS ? '555-8800'                 : isEN_US ? '(307) 555-0800'              : '+44 20 7946 0800',
        vskNumber:   isIS ? 'IS123456'                 : isEN_US ? 'EIN 82-1234567'              : 'GB123456789',
        bankAccount: existing.settings.company.bankAccount,
        auditor:     existing.settings.company.auditor,
      },
